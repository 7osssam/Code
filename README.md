This repository contains a collection of various projects, assignments, and resources related to programming, problem-solving, and interview preparation. It is organized into different directories based on the topics covered. 
...
│   ├── 32.  C function to SWAP two arrays with the same length.c
...
│   │   ├── 3_ check whether triangle is valid or not 2-methods.c
